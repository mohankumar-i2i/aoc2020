...
print("Result solution1: %d" % solution1(data))
...
def solution2(data):
    ...
    for x in data:
        ...
        position1 = pw[min-1] == letter[0]
        position2 = pw[max-1] == letter[0]
...
print("Result solution2: %d" % solution2(data))
